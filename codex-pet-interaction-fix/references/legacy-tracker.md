# Historical resident tracker — explicit opt-in only

This is the superseded workflow. Paths below are relative to the skill root. The default one-shot reset does not use CDP or this tracker.
